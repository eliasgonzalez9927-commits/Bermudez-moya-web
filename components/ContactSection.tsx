    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="relative pt-32 pb-20 px-4 overflow-hidden bg-slate-900">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-0 w-96 h-96 bg-red-600 rounded-full blur-[150px] -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <span className="inline-block px-4 py-1 bg-red-600/10 text-red-500 text-[10px] font-black uppercase tracking-[0.3em] rounded-full mb-6">Estamos para ayudarte</span>
          <h1 className="text-6xl md:text-7xl font-black text-white mb-6 tracking-tight">Hablemos de tu <br/><span className="text-red-600">próximo hogar</span></h1>
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-16 relative z-20 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 group">
              <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6 transition-colors group-hover:bg-red-600 group-hover:text-white duration-300">
                <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
              </div>
              <h3 className="text-xl font-black text-slate-900 mb-2">Visítanos</h3>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 group">
              <div className="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-6 transition-colors group-hover:bg-blue-600 group-hover:text-white duration-300">
              ...
              <h3 className="text-xl font-black text-slate-900 mb-2">Escríbenos</h3>
              <p className="text-slate-500 font-medium text-sm">bermudezmoyap@gmail.com</p>
              <p className="text-slate-400 text-xs mt-1">Respondemos en menos de 24hs</p>
            </div>
            ...
            <a 
              ...
              className="block bg-green-500 hover:bg-green-600 text-white p-8 rounded-[2.5rem] shadow-2xl shadow-green-100 transition-all hover:-translate-y-1 relative overflow-hidden group"
            >
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-xs font-black uppercase tracking-widest">Canal Directo</span>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl shadow-slate-200 border border-slate-100">
              ...
              {submitted ? (
                <div className="bg-green-50 border border-green-100 p-8 rounded-[2rem] text-center animate-in zoom-in-95 duration-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {error && (
                    <div className="bg-red-50 border border-red-100 p-4 rounded-2xl text-center text-red-600 font-bold animate-in fade-in duration-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                         type="text" 
                         required
                         className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-red-500/10 outline-none transition-all font-medium text-slate-700"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-4">Celular</label>
                      <input 
                         type="tel" 
                         required
                         className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-red-500/10 outline-none transition-all font-medium text-slate-700"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-4">Asunto de consulta</label>
                    <input 
                      type="text" 
                      className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-red-500/10 outline-none transition-all font-medium text-slate-700"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-4">¿En qué podemos ayudarte?</label>
                    <textarea 
                      rows={6}
                      required
                      className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-red-500/10 outline-none transition-all font-medium text-slate-700 resize-none"
                  ...
                  <button 
                    ...
                    className="w-full md:w-auto bg-red-600 text-white px-12 py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-red-700 transition-all shadow-xl shadow-red-100 disabled:opacity-50 flex items-center justify-center gap-3"
                  >
                    {isSubmitting ? (
                      <>
        ...
        <div className="mt-20">
          <div className="flex items-center gap-4 mb-8">
            <h2 className="text-3xl font-black text-slate-900">Ubicación Estratégica</h2>
            <div className="h-px flex-1 bg-slate-200"></div>
          </div>
          <div id="contact-map" className="w-full h-[600px] rounded-[3rem] shadow-2xl border-8 border-white overflow-hidden relative z-10">
            {/* El mapa se inicializa vía useEffect */}
          </div>
          <div className="mt-8 flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 gap-6">
             <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-slate-900 rounded-2xl flex items-center justify-center text-white font-black text-2xl">BM</div>
                <div>
                   <h4 className="font-black text-slate-900 text-lg uppercase tracking-tight">Oficina Central San Juan</h4>
                   <p className="text-slate-500 font-medium">Atención de Lunes a Viernes de 09:00 a 18:00hs</p>
                </div>
             </div>
             <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="px-8 py-4 bg-slate-100 hover:bg-slate-200 text-slate-800 font-black uppercase text-[10px] tracking-widest rounded-2xl transition-all"
             >
